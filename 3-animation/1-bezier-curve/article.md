...
베지어 곡선은 사실 매우 간단하며, 한번 공부할 가치가 있고 벡터 그래픽스와 고급 애니메이션 세계에서 편안함을 느낄 가치가 있습니다.

## 제어 점(Control points)

[베지어 곡선](https://en.wikipedia.org/wiki/B%C3%A9zier_curve)은 제어 점으로 정의됩니다.

제어 점은 2, 3, 4 혹은 더 많이 존재 할 수 있습니다.
...
3. **곡선은 항상 제어 점의 [컨벡스 헐(convex hull)](https://en.wikipedia.org/wiki/Convex_hull)안에 존재합니다:**
...
알고리즘은 재귀적이고 몇 개의 제어 점이든 일반화 할 수 있습니다.
...
우리는 베지어 곡선(Bezier curve)를 제어 점을 사용합니다. 우리가 볼 수 있듯이, 첫번째와 마지막 점을 제외하고 곡선이 아닙니다. 
...
베지어 곡선(Bezier curves)은 제어 점으로 정의됩니다.
