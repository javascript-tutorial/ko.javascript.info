...
>>>>>>> fcfef6a07842ed56144e04a80c3a24de049a952a:1-js/02-first-steps/15-function-expressions/article.md
...
2. 중괄호와 함께 작성: `(...args) => { body }` -- 본문이 여러 줄로 구성되었다면 중괄호를 사용해야 합니다. 리턴값을 반환해야 하는 경우에는 `return` 지시자를 사용해 반환 값을 명기해 주어야 합니다.
=======
