...
여기에 잘못된 비교보다 더 많은 결과가 있습니다. 전자 쇼핑 사이트를 만들고 방문자가 `$0.10` 및 `$0.20` 물품을 차트에 넣었다고 상상해보십시오. 주문 총액은 `$0.30000000000000004`입니다. 이는 누군가를 놀라게 할 것입니다.
...
```js run
// 저는 스스로 증가합니다.
alert( 9999999999999999 ); // 10000000000000000 을 보여준다.
```
